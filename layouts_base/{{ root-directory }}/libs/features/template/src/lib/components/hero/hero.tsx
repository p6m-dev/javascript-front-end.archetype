...
const tabs = [
  { name: 'apps/webapp/pages/mypage.tsx', isActive: true },
  ...
  return (
    <div className="overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]">
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20">
        <div className="container grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2 xl:gap-x-16">
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                ...
                <div className="pl-4 pt-4">
                  ...
                  <div className="mt-6 flex items-start px-1 text-sm">
                    ...
                    <div className="pl-6 font-semibold text-white">
                      ...
                      <span className="text-gray-300">{'>'}</span>
                      <span className="text-white">My Button</span>
                      <span className="text-gray-300">{'</'}</span>
                      <span className="text-green-300">Button</span>
                      <span className="text-gray-300">{'>'}</span>
                    </div>
